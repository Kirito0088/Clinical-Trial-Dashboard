...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-medium transition-colors disabled:pointer-events-none disabled:opacity-50 [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        primary: 'bg-[var(--color-signal)] text-white hover:brightness-110 active:brightness-95',
        secondary: 'bg-[var(--card)] text-[var(--fg)] border border-[var(--border)] hover:bg-[var(--bg)]',
        ghost: 'text-[var(--muted)] hover:bg-[var(--bg)] hover:text-[var(--fg)]',
